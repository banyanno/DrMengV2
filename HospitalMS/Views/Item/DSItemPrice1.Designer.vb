...
Partial Public Class DSItemPrice
    ...
    Partial Public Class ViewExpireDateDetialDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddViewExpireDateDetialRow(ByVal ItemCode As String, ByVal ItemName As String, ByVal UnitsInStock As Integer, ByVal PROVIDER_ID As Decimal, ByVal VenderName As String, ByVal EXPIRE_DATE As Date, ByVal Barcode As String, ByVal InventoryID As Integer, ByVal ItemID As Integer) As ViewExpireDateDetialRow
            Dim rowViewExpireDateDetialRow As ViewExpireDateDetialRow = CType(Me.NewRow,ViewExpireDateDetialRow)
            Dim columnValuesArray() As Object = New Object() {ItemCode, ItemName, UnitsInStock, PROVIDER_ID, VenderName, EXPIRE_DATE, Barcode, InventoryID, ItemID}
    ...
    Partial Public Class ViewExpireDateDetialRow
        ...
        Public Property ItemID() As Integer
            Get
                ...
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'ItemID' in table 'ViewExpireDateDetial' is DBNull.", e)
                End Try
            End Get
            Set
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Function IsItemIDNull() As Boolean
            Return Me.IsNull(Me.tableViewExpireDateDetial.ItemIDColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetItemIDNull()
            Me(Me.tableViewExpireDateDetial.ItemIDColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace DSItemPriceTableAdapters
    ...
    Partial Public Class ViewExpireDateDetialTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT        ItemCode, ItemName, UnitsInStock, PROVIDER_ID, VenderName, EXPIRE_D"& _ 
                "ATE, Barcode, InventoryID, ItemID"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            ViewExpireDateDetial"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand
            Me._commandCollection(1).Connection = Me.Connection
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function FillBy(ByVal dataTable As DSItemPrice.ViewExpireDateDetialDataTable, ByVal ItemID As Global.System.Nullable(Of Integer)) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (ItemID.HasValue = true) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], false)>  _
        Public Overloads Overridable Function SelectExpireByItemID(ByVal ItemID As Global.System.Nullable(Of Integer)) As DSItemPrice.ViewExpireDateDetialDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (ItemID.HasValue = true) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = CType(ItemID.Value,Integer)
            Else
